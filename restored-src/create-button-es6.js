// 还原后的创建按钮模块代码 (模块ID: 64905) - ES6版本
import { createPanelRow } from './panel-utils'; // 对应 n(66175)
...
export const createButton = ({
  ...
  buttonControl.addTarget(
    ...
    () => {
      // 发送分析事件
      Analytics.instance.fireEvent("button_click", {
  ...
  if (createWrapper) {
    // 如果需要包装器，创建面板行并添加按钮
    finalElement = createPanelRow({ customClass });
